...
namespace MeetingRoomReservation._3Data.Migrations
{
    ...
    [Migration("20210305145914_InitialCreate")]
            ...
            modelBuilder.Entity("MeetingRoomReservation._2Entities.Concrete.MeetingRoom", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 3, 5, 17, 59, 13, 710, DateTimeKind.Local).AddTicks(6087),
                            Description = "Buyuk Salon2",
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "Initial",
                            ModifiedDate = new DateTime(2021, 3, 5, 17, 59, 13, 710, DateTimeKind.Local).AddTicks(6237),
                            Name = "1 nolu Salon2",
                            Note = "note",
                            PersonCapacity = 12,
                            PlaceID = 1,
            ...
            modelBuilder.Entity("MeetingRoomReservation._2Entities.Concrete.Place", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedByName = "initial",
                            CreatedDate = new DateTime(2021, 3, 5, 17, 59, 13, 701, DateTimeKind.Local).AddTicks(9982),
                            IsActive = true,
                            IsDeleted = false,
                            ModifiedByName = "Initial",
                            ModifiedDate = new DateTime(2021, 3, 5, 17, 59, 13, 702, DateTimeKind.Local).AddTicks(1891),
            ...
            modelBuilder.Entity("MeetingRoomReservation._2Entities.Concrete.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedByName = "initial",
                            CreatedDate = new DateTime(2021, 3, 5, 17, 59, 13, 714, DateTimeKind.Local).AddTicks(2641),
                            IsActive = true,
                            IsDeleted = false,
                            MeetingDescription = "Test Desc Topantisi",
                            MeetingEndTime = new DateTime(2021, 3, 5, 18, 29, 13, 714, DateTimeKind.Local).AddTicks(572),
                            MeetingNotes = "Notlar",
                            MeetingRoomID = 1,
                            MeetingStartTime = new DateTime(2021, 3, 5, 17, 59, 13, 713, DateTimeKind.Local).AddTicks(9999),
                            MeetingSubject = "test toplanti Basliği",
                            MeetingType = 1,
                            ModifiedByName = "initial",
                            ModifiedDate = new DateTime(2021, 3, 5, 17, 59, 13, 714, DateTimeKind.Local).AddTicks(2149),
                            Note = "Not",
